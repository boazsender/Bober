...
if(!dojo._hasResource['client.vendor.jquery-form']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['client.vendor.jquery-form'] = true;
dojo.provide('client.vendor.jquery-form');
...
if(!dojo._hasResource['client.vendor.jquery-ba-serializeobject']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['client.vendor.jquery-ba-serializeobject'] = true;
dojo.provide('client.vendor.jquery-ba-serializeobject');
/*!
