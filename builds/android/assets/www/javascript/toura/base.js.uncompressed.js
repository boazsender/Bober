...
if(!dojo._hasResource['toura._PageDef']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura._PageDef'] = true;
...
if(!dojo._hasResource['toura._Store']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura._Store'] = true;
...
if(!dojo._hasResource['toura._Model']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura._Model'] = true;
...
if(!dojo._hasResource['toura.app.PhoneGap._base']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.app.PhoneGap._base'] = true;
...
if(!dojo._hasResource['toura.app.PhoneGap.notification']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.app.PhoneGap.notification'] = true;
...
if(!dojo._hasResource['toura.app.PhoneGap.camera']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.app.PhoneGap.camera'] = true;
...
if(!dojo._hasResource['toura.app.PhoneGap.geolocation']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.app.PhoneGap.geolocation'] = true;
...
if(!dojo._hasResource['toura.app.PhoneGap.accelerometer']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.app.PhoneGap.accelerometer'] = true;
...
if(!dojo._hasResource['toura.containers.Viewport']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.containers.Viewport'] = true;
...
dojo.declare('toura.containers.Viewport', [ toura._View ], {
  templateString : dojo.cache("toura.containers", "Viewport/Viewport.haml", "%ol.viewport\n"),
...
if(!dojo._hasResource['toura._Component']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura._Component'] = true;
...
dojo.declare('toura.components.ChildNodeGrid', toura._Component, {
  templateString : dojo.cache("toura.components", "ChildNodeGrid/ChildNodeGrid.haml", "%ul.component.child-node-grid\n  :each c in children\n    %li\n      %a{ href : c.url }\n        :if tablet\n          .image{ dojoType : 'toura.ui.BackgroundImage', imageUrl : c.featuredImage.large.url, loadOnInit: true }\n        :if phone\n          .image{ dojoType : 'toura.ui.BackgroundImage', imageUrl : c.featuredImage.small.url, loadOnInit: true }\n        %h3= c.name\n"),
  widgetsInTemplate : true,
...
if(!dojo._hasResource['toura.components.Debug']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.components.Debug'] = true;
dojo.provide('toura.components.Debug');



dojo.declare('toura.components.Debug', toura._Component, {
  templateString : dojo.cache("toura.components", "Debug/Debug.haml", ".component.debug\n  .status{ dojoAttachPoint : 'status' }\n\n  %table{ dojoAttachPoint : 'deviceInfo' }\n\n  %ul.actions\n    %li{ dojoAttachEvent : 'click:_weinre' } weinre\n    %li{ dojoAttachEvent : 'click:_resetDB' } reset\n\n"),
...
dojo.declare('toura.components._ImageScroller', toura.components._ImageGallery, {
  templateString : dojo.cache("toura.components", "_ImageScroller/ImageScroller.haml", ".component.image-scroller\n  .wrapper\n    %ol.images{ dojoAttachPoint : 'imageList' }\n      :each img in images\n        %li{ class : 'image ' + img.id }\n          .image{ dojoType : 'toura.ui.BackgroundImage', imageUrl : img.url }\n  %ol.indicator{ dojoAttachPoint : 'indicator' }\n    :each img in images\n      %li &#183;\n"),
...
if(!dojo._hasResource['toura.components._MediaCaption']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.components._MediaCaption'] = true;
...
if(!dojo._hasResource['toura._Capability']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura._Capability'] = true;
...
if(!dojo._hasResource['toura.capabilities.Page_GoogleMapTablet']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.capabilities.Page_GoogleMapPhone']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
...
if(!dojo._hasResource['toura.capabilities.Page_Videos']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.capabilities.Page_Videos'] = true;
...
if(!dojo._hasResource['toura.capabilities.VideoList_VideoPlayer']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.capabilities.VideoList_VideoPlayer'] = true;
...
if(!dojo._hasResource['toura.capabilities.VideoList_VideoCaption']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.capabilities.VideoList_VideoCaption'] = true;
...
if(!dojo._hasResource['toura.capabilities.Page_Search']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.capabilities.Page_Search'] = true;
...
if(!dojo._hasResource['toura.capabilities.Text_ChildNodes']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.capabilities.Text_ChildNodes'] = true;
...
if(!dojo._hasResource['toura.capabilities.Text_ChildNodes_VideoList']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.capabilities.Text_ChildNodes_VideoList'] = true;
...
if(!dojo._hasResource['toura.containers.Page']){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource['toura.containers.Page'] = true;
...
dojo.declare('toura.containers.Page', [ toura._View, toura.ui.BackgroundImage ], {
  pageDef : {},
  templateString : dojo.cache("toura.containers", "Page/Page.haml", "%li.page.node.configurable\n"),
